...
class darknetCrawler(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        with open('/home/harald/Desktop/Crawler-Bachelorseminar/darknetSpider/Links3/' + filename, 'wb') as f:
            f.write(response.body)
            self.log(f'Saved file {filename}')
        links = response.xpath("//a[contains(.,'security')]/@href").extract()
